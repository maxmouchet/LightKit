#
#  Be sure to run `pod spec lint LightKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Maxime Mouchet"
  # s.authors            = { "Maxime Mouchet" => "max@maxmouchet.com" }
  ...
  s.source       = { :git => "https://github.com/maxmouchet/LightKit.git", :tag => "0.0.1" }
